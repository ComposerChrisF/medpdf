...
pub use pdf_encryption::{
    EncryptionAlgorithm, EncryptionParams, encrypt_document, parse_permission_name,
    parse_permissions,
};
...
pub use types::{
    AddTextParams, DrawLineParams, DrawRectParams, FontStyle, FontWeight, HAlign, PdfColor,
    PlacePageParams, VAlign,
};
